...
The plugin requires Windows, Obsidian 1.12.7 or later, and either a Microsoft Store installation or a fully extracted portable package of stable DocWen 0.10.x. It accepts `docwen.machine.v2` and `docwen.artifact_bundle.v3`; other Bundle schemas and incompatible process envelopes fail closed.
