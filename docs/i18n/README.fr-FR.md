...
> **DocWen est requis.** Avant d'activer le plugin, installez et extrayez entièrement un [paquet Windows complet DocWen 0.9.x](https://github.com/ZHYX91/docwen/releases) compatible.
