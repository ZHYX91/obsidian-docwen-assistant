...
> **DocWen ist erforderlich.** Dieser Quellstand zielt auf DocWen 0.9.0 und DocWen Assistant 2.0.0; Quellversionen belegen keine veröffentlichte GitHub Release. Installieren Sie erst, wenn beide numerischen Releases samt festgelegten Dateien auf [DocWen Releases](https://github.com/ZHYX91/docwen/releases) und der Assistant-Release-Seite veröffentlicht sind.
...
- DocWen Assistant 2.0 benötigt `docwen.machine.v1` und `docwen.artifact_bundle.v2`; es gibt keinen Fallback auf argv-Befehle oder alte JSON-Umschläge.
...
Das Plugin übergibt nur einen isolierten Snapshot des aktuellen Editors oder der Vault-Datei an den lokalen CLI-Prozess. Es lädt keine Dokumente hoch und durchsucht nicht den gesamten Vault. Details: [CLI integration contract](https://github.com/ZHYX91/obsidian-docwen-assistant/blob/main/docs/cli-integration.md)
...
Stabile Verträge: [Produktanforderungen](../product-requirements.en.md) · [UX-Spezifikation](../ux-spec.en.md) · [Architektur](../architecture.en.md) · [Teststrategie](../testing-strategy.en.md) · [Release-Vertrag](../release.en.md)
